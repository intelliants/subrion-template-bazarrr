# subrion-template-bazarrr
Default template for Subrion Directory Script
...
What is important:
* The main file for compilation is `iabootstrap.less`. It should be compiled to `[root]/templates/bazarrr/css/iabootstrap.css`
